    ...
    <style>
        ...
        .hero-banner {
            background: linear-gradient(rgba(0, 0, 0, 0.85), rgba(8, 45, 78, 0)),
                url("<?php echo e(asset('images/julusiri fto.webp')); ?>") no-repeat center center/cover;
            color: white;
            padding: 140px 0;
            text-align: center;
        }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('images/logo3.png')); ?>" alt="Logo PKBM" class="me-2"
    ...
    <?php if(session('sukses_pendaftaran')): ?>
                ...
                <div class="card-body p-4 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="text-muted mb-0 font-monospace small" style="font-size: 14px;">
                            <i class="bi bi-info-circle me-1 text-primary"></i> <?php echo e(session('sukses_pendaftaran')); ?>
    ...
    <div class="position-relative w-100 vh-100 d-flex align-items-center justify-content-center text-center text-white"
        style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('<?php echo e(asset('images/fto julusiri.jpeg')); ?>') no-repeat center center; background-size: cover;">
        ...
        <section id="seksi-fasilitas" class="section-padding bg-white">
            ...
            <div class="row g-3 mt-4">
                <div class="col-md-4 col-sm-6">
                    <img src="<?php echo e(asset('images/ruangan julusiri.jpeg')); ?>" alt="Lingkungan Belajar PKBM Julu Siri"
                        class="img-fluid rounded shadow">
                </div>
                <div class="col-md-4 col-sm-6">
                    <img src="<?php echo e(asset('images/halaman julusiri.jpeg')); ?>" alt="Lingkungan Belajar PKBM Julu Siri"
                        class="img-fluid rounded shadow">
                </div>
                <div class="col-md-4 col-sm-6">
                    <img src="<?php echo e(asset('images/julusiri fto.webp')); ?>" alt="Lingkungan Belajar PKBM Julu Siri"
                        class="img-fluid rounded shadow">
                </div>
            </div>
    </div>
                ...
                <div class="modal-body p-4">
                    <div class="tab-content" id="authTabContent">
                        ...
                        <div class="tab-pane fade show active" id="login-panel" role="tabpanel"
                            ...
                            <form
                                action="<?php echo e(method_exists(Route::class, 'has') && Route::has('login') ? route('login') : url('/login')); ?>"
                                method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
    ...
    <div class="modal fade" id="modalSiswaBaru" tabindex="-1" aria-labelledby="modalSiswaBaruLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body p-4">
                    <?php if(session('error_data') || $errors->any()): ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <i class="bi bi-exclamation-triangle-fill me-2"></i>
                            <?php echo e(session('error_data') ?? 'Gagal mengirim pendaftaran. Periksa kembali kelengkapan data Anda!'); ?>
...
<?php /**PATH D:\Abdi\Laravel\pendaftaranpkbmjulusiri\resources\views/welcome.blade.php ENDPATH**/ ?>