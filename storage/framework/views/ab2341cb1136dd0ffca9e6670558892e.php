...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4 pb-3 border-bottom">
        <div>
            ...
            <p class="text-muted mb-0 small"><i class="bi bi-person-fill text-secondary me-1"></i> Memeriksa & Mengelola data calon siswa atas nama: <strong><?php echo e($pendaftar->nama); ?></strong></p>
        </div>
        <div>
            <!-- Tombol Kembali Tetap Mengarah ke URL Utama Admin -->
            <a href="<?php echo e(url('/elearning')); ?>" class="btn btn-light border rounded-pill px-4 shadow-sm fw-bold text-secondary">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="card form-box p-4 p-md-5">
                ...
                <form action="<?php echo e(route('admin.pendaftaran.update', $pendaftar->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nama" class="form-control fw-bold text-dark" value="<?php echo e($pendaftar->nama); ?>" required style="border-radius: 0 8px 8px 0; padding: 10px;">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <select name="paket" class="form-select fw-bold" required style="border-radius: 0 8px 8px 0; padding: 10px;">
                            <option value="Paket A" <?php echo e($pendaftar->paket == 'Paket A' ? 'selected' : ''); ?>>Paket A (Setara SD)</option>
                            <option value="Paket B" <?php echo e($pendaftar->paket == 'Paket B' ? 'selected' : ''); ?>>Paket B (Setara SMP)</option>
                            <option value="Paket C" <?php echo e($pendaftar->paket == 'Paket C' ? 'selected' : ''); ?>>Paket C (Setara SMA)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nohp" class="form-control fw-bold" value="<?php echo e($pendaftar->nohp); ?>" required style="border-radius: 0 8px 8px 0; padding: 10px;">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light fw-bold text-uppercase <?php if($pendaftar->status == 'Diterima'): ?> text-success <?php elseif($pendaftar->status == 'Ditolak'): ?> text-danger <?php else: ?> text-warning <?php endif; ?>" value="<?php echo e($pendaftar->status); ?>" readonly style="border-radius: 0 8px 8px 0; padding: 10px;">
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card form-box p-4">
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card-berkas p-3 d-flex justify-content-between align-items-center shadow-sm">
                            <div class="d-flex align-items-center gap-2">
                                <div class="fs-3 text-secondary"><i class="<?php echo e($info['icon']); ?>"></i></div>
                                <div>
                                    <span class="fw-bold d-block text-dark small" style="line-height: 1.2;"><?php echo e($info['label']); ?></span>
                                    <small class="text-muted" style="font-size: 0.75rem;"><?php echo e($pendaftar->$field ? 'File Terunggah' : 'Belum Ada File'); ?></small>
                                </div>
                            </div>
                            
                            <?php if($pendaftar->$field): ?>
                                <a href="<?php echo e(asset('storage/' . $pendaftar->$field)); ?>" target="_blank" class="btn btn-sm <?php echo e($info['color']); ?> rounded-pill px-3 shadow-sm fw-bold text-xs">
...
</div><?php /**PATH D:\Abdi\Laravel\pendaftaranpkbmjulusiri\resources\views/admin/show_pendaftar.blade.php ENDPATH**/ ?>