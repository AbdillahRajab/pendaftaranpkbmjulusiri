...
<body class="bg-light">
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap g-3">
                <div>
                    <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-3 mb-2">Ruang Kelas
                        Aktif</span>
                    <h2 class="fw-bold text-dark mb-1">{{ $kelas->nama_kelas }}</h2>
                    <p class="text-muted mb-0">{{ $kelas->deskripsi ?: 'Tidak ada deskripsi kelas.' }}</p>
                </div>
                ...
                @if (Auth::user() && Auth::user()->role == 'tutor')
                    <div class="d-flex gap-2 mt-2 flex-wrap">
                        <button class="btn btn-outline-dark rounded-3" data-bs-toggle="modal"
                            ...
                            {{ $kelas->password_kelas ? 'Aktif' : 'Terbuka' }}
                        </button>
                        ...
                        <form action="/ruang-kelas/{{ $kelas->id }}/hapus" method="POST"
    ...
    <div class="modal fade" id="modalPasswordKelas" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form action="/ruang-kelas/{{ $kelas->id }}/update-password" method="POST"
